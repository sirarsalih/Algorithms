...
int main()
{
	...
	std::map<std::string, int> mapClustersStates;
	int bestSoFar = 0;
	...
	{	
		...
		if(fileFormat == "txt")
		{
			...
			mc.cluster(foutput, mapClustersStates, bestSoFar, numberOfXLiterals, levelCounter, mapLevelClusters, vectorStringNumbers, numberOfLiterals, numberOfClauses, initialClusterCollection, clusterCollection, mapLiteralValues, mapClauseValues, begin);
			...
			ts.run(foutput, mapClustersStates, bestSoFar, noLettersCollectionString, numberOfLiterals, levelCounter, mapLevelClusters, vectorStringNumbers, initialClusterCollection, clusterCollection, mapLiteralValues, mapClauseValues, numberOfXLiterals, numberOfClauses, multiMapLiteralClause, begin);
			...
			std::cout << "Time elapsed Learning Automata: " << timeElapsedTabuSearch << " seconds" << std::endl;
