...
int main()
{
	...
	{	
		...
		if(fileFormat == "txt")
		{
			...
			ts.run(foutput, noLettersCollectionString, numberOfLiterals, vectorStringNumbers, mapLiteralValues, mapClauseValues, numberOfXLiterals, numberOfClauses, multiMapLiteralClause, begin);
			...
			std::cout << "Time elapsed Tabu Search: " << timeElapsedTabuSearch << " seconds" << std::endl << std::endl;
			foutput << "\nTotal time elapsed: " << timeElapsedTabuSearch << " seconds";
			foutput.close();
